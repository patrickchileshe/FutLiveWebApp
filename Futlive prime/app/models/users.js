...
//This is our users model, this is where we handle the database interactions for our users, 
// we have functions to create a user, get a user and check the credentials of a user, 
// we also have a function to hash the password using PBKDF2 with a salt and a number of iterations for security
